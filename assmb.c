...
void print_assembly_code(instruction_cell *Noaux)
{
    ...
    while (Noaux != NULL)
    {
        ...
        case regTemporary:
            ...
            fprintf(output_file," $r%d", Noaux->op1.value);
            break;
        case constant:
           
            fprintf(output_file," %d", Noaux->op1.value);
            break;
        case labelk:
            
            fprintf(output_file, "L%d:", Noaux->op1.value);
            label_flag = false;
            break;
        case funck:
        ...
        case regTemporary:
            ...
            fprintf(output_file,", $r%d", Noaux->op2.value);
            break;
        case constant:
            
            fprintf(output_file,", %d", Noaux->op2.value);
            break;
        case funck:
            
            fprintf(output_file," %s", Noaux->op2.name);
            break;
        }
        ...
        case regTemporary:
            ...
            fprintf(output_file,", $r%d", Noaux->op3.value);
            break;
        case constant:
            
            fprintf(output_file,", %d", Noaux->op3.value);
            break;
        case labelk:
            
            fprintf(output_file,", L%d", Noaux->op3.value);
            break;
        }
